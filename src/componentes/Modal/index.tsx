...
export function BasicModal() {
  ...
  return (
    <div>
      <button
        onClick={handleOpen}
        className="flex h-12 w-[200px] items-center justify-center gap-[5px] rounded-[5px] border-2 border-red bg-red text-base text-white transition-all duration-500 hover:bg-transparent"
      >
        Um pouco sobre mim
      </button>
      <Modal
